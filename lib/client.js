...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function apply(ctx) {
			...
			console.log("[settings-nav-organizer] v1.5.0 loaded");
						...
						aiOn
							? React.createElement(React.Fragment, null,
								React.createElement("div", { className: "dsh-snav-gitems" },
									...
									React.createElement("input", { className: "dsh-snav-input", placeholder: tPage("aiModel"), value: aiDraft.model, onChange: (e) => setAiDraft({ ...aiDraft, model: e.target.value }) }),
									React.createElement("div", { className: "dsh-snav-ghead" },
